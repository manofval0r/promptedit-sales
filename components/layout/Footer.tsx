...
export default function Footer() {
  return (
    <footer className="w-full px-5 md:px-8 lg:px-16 pb-12 pt-6 relative overflow-hidden mt-auto">
      {/* Main Footer Rounded Card Container */}
      <div className="max-w-[1200px] mx-auto bg-bg-surface/80 backdrop-blur-xl border border-border-subtle rounded-[40px] p-8 md:p-12 lg:p-16 relative z-10 shadow-2xl">
